...
class MainActivity : ComponentActivity() {
    ...
    private fun MainUI(playerViewModel: PlayerViewModel, navController: NavHostController) {
        ...
        val commonNavItems = remember {
            persistentListOf(
                BottomNavItem("在听", R.drawable.rounded_home_24, R.drawable.home_24_rounded_filled, Screen.Home),
                BottomNavItem("搜索", R.drawable.rounded_search_24, R.drawable.rounded_search_24, Screen.Search),
                BottomNavItem("曲库", R.drawable.rounded_library_music_24, R.drawable.round_library_music_24, Screen.Library)
            )
        }
